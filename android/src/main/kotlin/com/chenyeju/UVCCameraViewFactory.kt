...
class UVCCameraViewFactory(
    ...
    // --- PENERUS FILTER GAMBAR ---
    fun setBrightness(brightness: Int) = cameraView.setBrightness(brightness)
    fun getBrightness(): Int = cameraView.getBrightness()

    fun setContrast(contrast: Int) = cameraView.setContrast(contrast)
    fun getContrast(): Int = cameraView.getContrast()
